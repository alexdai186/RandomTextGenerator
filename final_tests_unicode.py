...
class RandomWriterTests(unittest.TestCase):
    ...
    The entire set of tests should not take more than 30 seconds to
    run. My implementation takes 9s (on an i5 at 3.3Ghz). My
    implementation is not particularly optimized. Just make sure you are
    not interating any sequences repeatedly when you don't need to or
    anything like that.
    """
